...
class Demo extends Scene {
    ...
    function demoTint(x:Float, y:Float, w:Float, h:Float, d:Float) {
        ...
        text0.pos(image0.x, image0.y - h * 0.2);
        text0.depth = 99;
        text0.pointSize = 16;
        container.add(text0);
        ...
        text1.pos(image1.x, image1.y - h * 0.2);
        text1.depth = 99;
        text1.pointSize = 16;
        container.add(text1);
        ...
        text3.pos(image2.x, image2.y - h * 0.2);
        text3.depth = 99;
        text3.pointSize = 16;
        container.add(text3);
    ...
    function demoTextures(x:Float, y:Float, w:Float, h:Float, d:Float) {
        ...
        text1.color = Color.WHITE;
        text1.anchor(0.5, 0.5);
        text1.pos(quad1.x, quad1.y - h * 0.15);
        text1.depth = 99;
        text1.pointSize = 16;
        container.add(text1);
        ...
        text2.pos(quad2B.x, quad2B.y - h * 0.15);
        text2.depth = 99;
        text2.pointSize = 16;
        container.add(text2);
        ...
        text3.color = Color.WHITE;
        text3.anchor(0.5, 0.5);
        text3.pos(filter1.x, filter1.y - h * 0.15);
        text3.depth = 99;
        text3.pointSize = 16;
        container.add(text3);
        ...
        text4.pos(filter2.x, filter2.y - h * 0.15);
        text4.depth = 99;
        text4.pointSize = 16;
        container.add(text4);
